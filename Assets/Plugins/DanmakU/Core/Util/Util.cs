...
namespace DanmakU {
    ...
    public static class Util {
        ...
        public static T[] GetComponents<T>(GameObject gameObject)
            where T : class {
        ...
        public static T[] GetComponentsInChildren<T>(GameObject gameObject)
            where T : class {
        ...
        public static T[] GetComponentsInParent<T>(GameObject gameObject)
            where T : class {
        ...
        public static T[] GetComponentsPrealloc<T>(GameObject gameObject,
                                                   T[] prealloc,
        ...
        private static T[] FindObjectByType<T, V>() where T : class
        ...
        public static Vector2 OnUnitCircle(float degrees) {
            ...
            return new Vector2((float) Math.Cos(radians),
