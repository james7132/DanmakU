    ...
    public class DanmakuField : MonoBehaviour
    {
        ...
        public static DanmakuField FindClosest(Vector2 position)
        {
            if (_fields == null)
            {
                ...
                _fields.AddRange(Object.FindObjectsOfType<DanmakuField>());
            }
            if (_fields.Count == 0)
            {
        ...
        [SerializeField] private bool useClipBoundary = true;
        ...
        [SerializeField] private float clipBoundary = 1f;
        ...
        [SerializeField] private List<Camera> otherCameras;
        ...
        public GameObject SpawnGameObject(GameObject prefab, Vector2 location,
        ...
        public T SpawnObject<T>(T prefab, Vector2 location, CoordinateSystem coordSys = CoordinateSystem.View)
            where T : Component
        {
            if (TargetField == null)
                TargetField = this;
        ...
        public Danmaku SpawnDanmaku(DanmakuPrefab bulletType, Vector2 location, DynamicFloat rotation,
            CoordinateSystem coordSys = CoordinateSystem.View)
        {
            if (TargetField == null)
                TargetField = this;
